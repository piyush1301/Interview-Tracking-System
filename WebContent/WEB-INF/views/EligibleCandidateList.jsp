...
<!-- content begins -->
 <div id="main">
	<div id="right">
		...
		<h1><u><center><a href="login.html">Eligible Candidate List</a></u></center></h1><br/></br><br/></br>	
			<table border="2" cellpadding="2" align="center">
				...
				<c:forEach items="${BeanList}" var="details">
				<tr>
					<td><c:out value="${details.candidateID}"/></td>
					<td><c:out value="${details.profile.firstName}"/></td>
					<td><c:out value="${details.profile.lastName}"/></td>
					<td><c:out value="${details.profile.mobileNo}"/></td>
					<td><c:out value="${details.profile.emailId}"/></td>
					...
					<td>
						<form action="ScheduleInterview.html" method="POST">
							<input type="hidden" name="candidateID" value="${details.candidateID}">
