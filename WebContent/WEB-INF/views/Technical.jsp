...
<!-- content begins -->
 <div id="main">
	<div id="right">
		<h4>This Candidate is being interviewed for the first time in our company</h4>
			<form:form commandName="TechDetails" action="VerifyTechnical.html" method="POST" name="formCheck" onsubmit="return CheckIT()">
				<table>
					<tr>
					...
					<tr>
						...
						<td><form:input path="interviewDate" id="datepicker" value=""/></td>
					</tr>
					
					<tr>
						<td>Interview Time</td>
						<td><form:input path="interviewTime" value=""/></td>
					</tr>
				</table>
				<form:hidden path="candidateBean.candidateID" value="${C_ID}"/>
				<input type="submit" value="Check Avalibility">
			</form:form>
		<h4>Click on Check Avalibility to see that whether the interviewer is avaliable on that date on note</h4>
		</div>
	<div id="left">	
	<h3>FEATURES</h3>
			<ul>
