...
<script>
	function CheckIT()
	{
		var a=formCheck.interviewID.value;
		
		if(a=="")
			{
				alert("Please Provide Interview ID");
				return false;
			}
		else
			{
...
<!-- content begins -->
 <div id="main">
	<div id="right">
			<form:form commandName="ResultInfo" action="FixResultInfo.html" method="POST" name="formCheck" onsubmit="return CheckIT()">
				<table>
					<tr>
						<td>Interview ID</td>
					...
					<tr>
						<td>Share Result With</td>
						<td>
							<form:select path="shareResult">
