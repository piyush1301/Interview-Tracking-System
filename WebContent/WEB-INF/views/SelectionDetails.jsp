...
<script>
function checkFun() {
	var b=checkIt.experience.value;

	
	 if(b=="")
		{
			alert("Please Provide Candidate Experience");
			return false;
		}
	 else if(b>25)
		{
...
<h1><u><center><a href="login.html">Selection Details</a></u></center></h1><br/></br><br/></br>
<form:form commandName="CandidateSkillSet" action="GetCandidates.html" method="POST" name="checkIt"  onsubmit="return checkFun()">
			<table>
				<tr>
					<td>Candidate Skill</td>
					<td>
					<form:select path="primarySkills" value="">
				...
				<tr>
					<td>Candidate Experience Required</td>
					<td><form:input path="experience" value=""/></td>
					
				</tr>
				
				<tr>
					<td>Candidate Qualification Required</td>
						<td>
