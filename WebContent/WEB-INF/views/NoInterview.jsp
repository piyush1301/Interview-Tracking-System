...
<!-- content begins -->
 <div id="main">
	<div id="right">
		<h1>The Candidate has given a interview within 30 days and he was unsuccessfull</h1>
		<h1>Accourding to the rules we can't schedule the interview right now</h1>
		</div>
	<div id="left">	
	<h3>FEATURES</h3>
			<ul>
