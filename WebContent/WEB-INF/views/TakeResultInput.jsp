 ...
 <div id="main">
	<div id="right">
		<h2><b><center><font color="blue" size="6"><u>Welcome to XYZ Solutions!!</u></font></center></b></h2><br/></br><br/>
			...
			<form:form commandName="takeResultDecision" action="CheckResult.html" method="POST" name="formCheck" onsubmit="return CheckIT()">
				<table>
					<tr>
						<td>Interview ID</td>
						<td><form:input path="interviewID" name=""/></td>
					</tr>
				</table>
