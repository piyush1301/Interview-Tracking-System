...
function CheckIT()
	{
			...
			if(a=="")
				{
					alert("Please Give InterView Id");
					return false;
				}
...
<h1><u><center><a href="login.html">Interview Ratings</a></u></center></h1><br/></br><br/></br>
		<form:form commandName="GetRatings" action="ProcessRating.html" method="POST" name="formCheck" onsubmit="return CheckIT()">
			<table>
				<tr>
					<td>Interview ID</td>
					<td><form:input path="interviewID" value=""/></td>
				</tr>
			</table>
