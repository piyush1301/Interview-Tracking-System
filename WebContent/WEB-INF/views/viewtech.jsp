...
<%--  <%
 ...
 --%> 
<form:form action="viewtechdet.html" method="get">
...
tech employee</td>
<td>
<form:select path="techPanelBean.techID">
<form:option value="TE01" label="Arjun"></form:option>
<form:option value="TE02" label="Krishna"></form:option>
<form:option value="TE03" label="Girish"></form:option>
</form:select>
</td>
</tr>
<tr>
<td>Interview Date:</td>
<td><form:input path="interviewDate" id="DateField" readonly="true"/></td>
</tr>
