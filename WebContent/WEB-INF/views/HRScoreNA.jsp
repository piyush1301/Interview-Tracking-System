...
<!-- content begins -->
 <div id="main">
	<div id="right">
			<h1>This candidate has cleared the technical interview and given the HR interview</h1>
			<h1>But the scores for HR is not yet arrived</h1>
			<h1>So we can't process it ahead</h1>
			</div>
	<div id="left">	
	<h3>FEATURES</h3>
			<ul>
