...
<!-- content begins -->
 <div id="main">
	<div id="right">
		...
		<h1><u><center><a href="login.html">Details of Interview</a></u></center></h1><br/></br><br/></br>
			...
			<h6>HR Rating will be null/blank if Technical Rating is less than or equal to 2.5</h6>
			<h6>If HR rating is null/blank even if Technical Rating is greater than 2.5 then it means HR Rating is not given By HR</h6>
			<h6>If both ratings are null/blank it means Technical Rating is not given by the interviewer</h6>
			</div>
	<div id="left">	
	<h3>FEATURES</h3>
			<ul>
