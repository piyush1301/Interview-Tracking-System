...
<script>
	...
	function CheckIT()
	{
		var a=formError.candidateID.value;
		
		if(a=="")
			{
			alert("Please Provide Candidate ID");
			return false;
			}
...
<h1><u><center><a href="login.html">Share Information</a></u></center></h1><br/></br><br/></br>
			<form:form commandName="sharing" method="POST" action="fixSharing.html" name="formError" onsubmit="return CheckIT()">
				<table>
					<tr>
						<td>Candidate Id</td>
						<td><form:input path="candidateID" value=""/></td>
					</tr>
					
					<tr>
						<td>Share Info With</td>
						<td>
						<form:select path="shareDetails">
							<form:option value="0" label="NONE"/>
							<form:option value="1" label="TECH"/>
							<form:option value="2" label="HR"/>
