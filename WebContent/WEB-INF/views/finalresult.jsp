...
<%@page import="com.wipro.its.bean.InterviewScheduleBean"%>
 ...
 <div id="menu1">
  <div id="menu">
		<ul>
				...
				<li id="button2"><a href="goToHR.html" title="">Home</a></li>
...
<%
	InterviewScheduleBean bean = (InterviewScheduleBean)request.getAttribute("bean");
	Date d = bean.getEmpHRInterviewDate();
	SimpleDateFormat sdf = new SimpleDateFormat("dd-MMM-yyyy");
	String date = sdf.format(d);
%>
<td><c:out value="<%=date%>"/></td>
<td><c:out value="${bean.empHRInterviewTime}"/></td>
<td><c:out value="${bean.empHRRating}"/></td>
</tr>
</table>
</div>
	<div id="left">	
